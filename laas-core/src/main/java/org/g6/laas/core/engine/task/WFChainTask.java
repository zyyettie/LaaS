...
@Slf4j
@Data
public abstract class WFChainTask implements AnalysisTask<Map<String, Object>> {
    ...
    public WFChainTask(AnalysisContext context, Map<String, Object> retMap) {
        this.context = context;
        this.retMap = retMap;
    }

    public WFChainTask(AnalysisContext context) {
        this.context = context;
    }
