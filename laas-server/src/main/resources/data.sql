...
insert into WORKFLOW(ID, NAME, SCENARIO_ID) values(1, 'Task - Top N', 1)
insert into WORKFLOW(ID, NAME, SCENARIO_ID) values(2, 'Task - RAD Show', 2)
insert into WORKFLOW(ID, NAME, SCENARIO_ID) values(3, 'Task - Login Time', 3)
insert into WORKFLOW(ID, NAME, SCENARIO_ID) values(4, 'Task - Split Process/Thread',  4)
insert into WORKFLOW(ID, NAME, SCENARIO_ID) values(5, 'Task - SM-OMi Performance', 5)
insert into WORKFLOW(ID, NAME, SCENARIO_ID) values(6, 'Task - SM RTE', 6)
