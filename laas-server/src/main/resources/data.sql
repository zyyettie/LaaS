...
insert into SCENARIO(ID, NAME, product_id) values(1, 'Service - Top N', 1)
insert into SCENARIO(ID, NAME, product_id) values(2, 'Service - RAD Show', 1)
insert into SCENARIO(ID, NAME, product_id) values(3, 'Service - SM ENV Info', 1)
insert into SCENARIO(ID, NAME, product_id) values(4, 'Service - Split Process/Thread', 1)
insert into SCENARIO(ID, NAME, product_id) values(5, 'Service - SM-OMi Performance', 1)
insert into SCENARIO(ID, NAME, product_id) values(6, 'Service - SM Testing', 1)
...
insert into scenario_input_parameter_defs(scenarios_id, input_parameter_defs_id) values(1, 1)
insert into scenario_input_parameter_defs(scenarios_id, input_parameter_defs_id) values(1, 2)
insert into scenario_input_parameter_defs(scenarios_id, input_parameter_defs_id) values(1, 3)
insert into scenario_input_parameter_defs(scenarios_id, input_parameter_defs_id) values(4, 4)
insert into scenario_input_parameter_defs(scenarios_id, input_parameter_defs_id) values(4, 5)
insert into scenario_input_parameter_defs(scenarios_id, input_parameter_defs_id) values(3, 6)
