...
insert into WORKFLOW(ID, NAME, SCENARIO_ID, PRODUCT_ID) values(1, 'Workflow - Top N', 1, 1)
insert into WORKFLOW(ID, NAME, SCENARIO_ID, PRODUCT_ID) values(2, 'Workflow - RAD Show', 2, 1)
insert into WORKFLOW(ID, NAME, SCENARIO_ID, PRODUCT_ID) values(3, 'Workflow - Login Time', 3, 1)
insert into WORKFLOW(ID, NAME, SCENARIO_ID, PRODUCT_ID) values(4, 'Workflow - Split Process/Thread',  4, 1)
insert into WORKFLOW(ID, NAME, SCENARIO_ID, PRODUCT_ID) values(5, 'Workflow - SM-OMi Performance', 5, 1)
insert into WORKFLOW(ID, NAME, SCENARIO_ID, PRODUCT_ID) values(6, 'Workflow - SM RTE', 6, 1)
...
insert into WORKFLOW_TASK(ID, WORKFLOW_ID,TASK_ID,TASK_ORDER) values(1, 1,1,1)
insert into WORKFLOW_TASK(ID, WORKFLOW_ID,TASK_ID,TASK_ORDER) values(2, 2,2,1)
insert into WORKFLOW_TASK(ID, WORKFLOW_ID,TASK_ID,TASK_ORDER) values(3, 3,3,1)
insert into WORKFLOW_TASK(ID, WORKFLOW_ID,TASK_ID,TASK_ORDER) values(4, 4,4,1)
insert into WORKFLOW_TASK(ID, WORKFLOW_ID,TASK_ID,TASK_ORDER) values(5, 5,5,1)
insert into WORKFLOW_TASK(ID, WORKFLOW_ID,TASK_ID,TASK_ORDER) values(6, 6,6,1)

insert into workflow_file_types(workflow_id, file_types_id) values(1, 1)
insert into workflow_file_types(workflow_id, file_types_id) values(2, 1)
insert into workflow_file_types(workflow_id, file_types_id) values(3, 1)
insert into workflow_file_types(workflow_id, file_types_id) values(4, 1)
insert into workflow_file_types(workflow_id, file_types_id) values(5, 1)
insert into workflow_file_types(workflow_id, file_types_id) values(6, 1)
...
insert into workflow_parameter_defines(workflow_id, parameter_defines_id) values(1, 1)
insert into workflow_parameter_defines(workflow_id, parameter_defines_id) values(1, 2)
insert into workflow_parameter_defines(workflow_id, parameter_defines_id) values(1, 3)
insert into workflow_parameter_defines(workflow_id, parameter_defines_id) values(3, 4)
insert into workflow_parameter_defines(workflow_id, parameter_defines_id) values(3, 5)
insert into workflow_parameter_defines(workflow_id, parameter_defines_id) values(3, 6)
