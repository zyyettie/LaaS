...
insert into FILE_TYPE(ID, NAME) values(1, 'RTE Log')
insert into FILE_TYPE(ID, NAME) values(2, 'SM Config')
...
insert into WORKFLOW_TASK(ID, WORKFLOW_ID, TASK_ID) values(1, 1, 1)
insert into WORKFLOW_TASK(ID, WORKFLOW_ID, TASK_ID) values(2, 2, 2)
insert into WORKFLOW_TASK(ID, WORKFLOW_ID, TASK_ID) values(3, 3, 3)
insert into WORKFLOW_TASK(ID, WORKFLOW_ID, TASK_ID) values(4, 4, 4)
insert into WORKFLOW_TASK(ID, WORKFLOW_ID, TASK_ID) values(5, 5, 5)
insert into WORKFLOW_TASK(ID, WORKFLOW_ID, TASK_ID) values(6, 6, 6)

insert into SCENARIO(ID, NAME, PRODUCT_ID, USER_ID) values(1, 'Test Scenario', 1, 1)

insert into SCENARIO_WORKFLOW(ID, SCENARIO_ID, WORKFLOW_ID) values(1, 1, 1)
insert into SCENARIO_WORKFLOW(ID, SCENARIO_ID, WORKFLOW_ID) values(2, 1, 2)
insert into SCENARIO_WORKFLOW(ID, SCENARIO_ID, WORKFLOW_ID) values(3, 1, 3)
insert into SCENARIO_WORKFLOW(ID, SCENARIO_ID, WORKFLOW_ID) values(4, 1, 4)
insert into SCENARIO_WORKFLOW(ID, SCENARIO_ID, WORKFLOW_ID) values(5, 1, 5)
insert into SCENARIO_WORKFLOW(ID, SCENARIO_ID, WORKFLOW_ID) values(6, 1, 6)
