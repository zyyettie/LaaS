...
insert into USER(ID,NAME,password,ROLE_ID,inbox_id, quota_id) values(1,'admin','password',1,1, 1)
insert into USER(ID,NAME,password,ROLE_ID,inbox_id, quota_id) values(2,'user1','password',2,2, 2)
...
insert into INPUT_PARAMETER_DEF(ID, NAME, DISPLAY_INFO, TYPE, WIDTH, HEIGHT, line_occupied, task_id) values(4, 'userName', 'User Name', 'text', 1, 1, true, 7)
